...
/**
 * This class will pre-load in data for the development and production profiles.
 * It will create similar sample data to the default Bootstrap class except there will be checks
 * before creating sample users, roles, and searches.
 */
@Slf4j
@Component
@Profile({"development", "production"})
public class SpringJPAPostgresBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    /**
