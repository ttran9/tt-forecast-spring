...
public interface RegistrationService {
    ...
    /**
     * Takes in the userName and password from the form and saves it into the User object and
     ...
     */
    User registerUser(RegistrationFormCommand registrationFormCommand);
}
